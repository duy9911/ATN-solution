<?php 
{
     ...
     $port = '5432';
         ...
         $connection = new pg_connect ($server, $db, $username, $password, $port);
...
function queryMysql($query)
{
	...
	{
		$connection = new pg_connect($this->dbhost, $this->dbuser, $this->dbpassword, $this->dbname);
		//chay cau truy van
		$result = $connection->query($query);
		//dong ket noi
		$connection->close();
	...
	{
		$conn = new pg_connect($this->host, $this->un, $this->pw, $this->dbname);
